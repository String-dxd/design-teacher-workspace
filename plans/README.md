...
| 014 | Dead code: remove ~10 dead files (3 orphaned subtrees) + ~11 dead deps + declare transitive `@tanstack/react-query` | P2 | S | — | DONE — executor branch `worktree-agent-a1f5ec758ac0d64ff` (commit `14a8ee8`), reviewer-verified 2026-07-01: 9 files + 12 deps removed, react-query@5.90.21 declared; gates green (build 0 / tsc 110 / vitest 37-16), scope clean. NOT merged — awaiting a removal PR. |
| 015 | Dead code: strip 68 unused imports/locals (TS6133); unblocks a blocking typecheck CI gate | P2 | S–M | 014 (recommended) | TODO |
| 016 | Dead code: remove ~10 dead public assets + untrack committed `.DS_Store` | P3 | S | — | TODO |
| 017 | Dead code: prune ~40 dead non-UI exports (unexport→tsc→delete); keeps shadcn ui/ primitive API | P3 | M | 014 (re-run knip after) | TODO |
