...
| 026 | Hub scope filter (pinned form class + level groups), four-checkpoint table (Results/Comments/Approval/Parents), contextual row actions, staggered parent acknowledgement, shared Parents Gateway preview dialog | P1 | L | shipped pipeline (`a2c2db2`) | TODO — written 2026-07-09 from user requirements session; decisions locked in plan. |
