...
> mandatory before any deletion (some assets are referenced via _constructed_ paths, not
...
- `public/report-previews/*-thumb.png` (imh-cgc, cps, msf-psv, intake, sc-swo-a, sc-swo-b,
  ...
  _bare_ `assq.png` / `children-home.png` (no `-thumb`) and `nric-report-thumb.png`
