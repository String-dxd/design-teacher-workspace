              ...
              <>
                <button
                  ...
                  onClick={() => {
                    ...
                    setOpen(false)
                    // The popover restores focus to the column trigger on
                    // close, leaving its native focus ring lit indefinitely —
                    // blur it so the ring clears once the choice is made.
